...
(defun csid-generate-html (&optional file summaries)
  (let ((data
    ...
    (with-temp-file (or file "/tmp/csid.html")
      (if summaries
	  (insert "<title>Konserter i Oslo</title><meta charset='utf-8'><link href='csid.css?ts=%s' rel='stylesheet' type='text/css'><h1>Konserter i Oslo</h1><h2>Concerts in Oslo</h2>")
	(insert
	 (format
