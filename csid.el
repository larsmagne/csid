...
(defvar csid-sources
  '(("Revolver" "https://www.facebook.com/revolveroslo/events/?ref=page_internal" facebook (59.917146 10.749779))
    ...
    ("Enga" "https://www.facebook.com/engapub/events/" facebook (59.907470 10.783760))
    ...
    ("Salt" "https://www.facebook.com/pg/SaltArtMusic/events/?ref=page_internal" facebook (59.90704963300261 10.746273380187537))
    ...
    ("Tukthuset" "https://www.facebook.com/Tukthuset/events?locale=nb_NO" facebook (59.914668289423474 10.751130301904967))
    ...
    ("Munchmuseet" "https://www.munchmuseet.no/hva_skjer/?category=Musikk" munch (59.90603859878417 10.755181524147991))
    ...
    ("Børsen kulturhus" "https://www.facebook.com/borsenkulturhus/events" facebook (60.618114318273285 11.267923632287015) :nobound)
    ))
	   ...
	   collect (let ((parent (dom-parent dom event))
		     ...
		     (while (and parent (not time))
		       (cl-loop for span in (dom-by-tag parent 'span)
				for tim = (csid-parse-facebook-time
					   (dom-text span))
...
(defun csid-generate-html (&optional file summaries)
  (let ((data
    ...
    (with-temp-file (or file "/tmp/csid.html")
      (if summaries
	  (insert "<title>Konserter i Oslo</title><meta charset='utf-8'><link href='csid.css?ts=%s' rel='stylesheet' type='text/css'><meta name='viewport' content='width=device-width, initial-scale=1'><h1>Konserter i Oslo</h1><h2>Concerts in Oslo</h2>")
	(insert
	 (format
