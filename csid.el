...
(defun csid-generate-html (&optional file summaries)
  (let ((data
    ...
    (with-temp-file (or file "/tmp/csid.html")
      (if summaries
	  (insert "<title>Concerts in Oslo</title><link href='csid.css?ts=%s' rel='stylesheet' type='text/css'><h1>Konserter i Oslo</h1><h2>Concerts in Oslo</h2>")
	(insert
	 (format
...
(defun csid-write-date (dir &optional date)
  ...
  (let ((database (sort (copy-sequence csid-database)
    ...
    (with-temp-buffer
      (insert
       (format
	"<head><title>Crowdsourcing Is Dead</title><meta charset='utf-8'><link href='https://csid.no/csid.css' rel='stylesheet' type='text/css'><meta name='viewport' content='width=device-width, initial-scale=1'><link rel='preload' href='pikaday.css' as='style' onload=\"this.onload=null;this.rel='stylesheet'\"><noscript><link rel='stylesheet' href='pikaday.css'></noscript><link rel='icon' href='https://csid.no/favicon.ico'><body><div id='body-container'><div id='large-heading'><a href=\"https://csid.no/\"><img src='https://csid.no/csid.png' id='logo'></a><p>(Also known as <a href='https://lars.ingebrigtsen.no/2013/09/crowdsourcing-is-dead.html'>'Concerts In Oslo' or 'Konserter i Oslo'</a> on %s.)</p></div><div id='small-heading'><span class='box-shadow-menu' id='small-menu'></span></div>Crowdsourcing Is Dead</div>"
